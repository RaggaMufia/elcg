/* elcgnorm.c - elcg Gaussian distribution Version 1.0.0             */
...
void boxmul(llfmt *ll, double mean,
...
int main(int argc, char **argv)
   ...
   ll = (llfmt *) elcginit();   /* initialize elcg to date/time */
   ...
   while (i--)
      {
      boxmul(ll,mean,stdev,aa);        /* Box-Muller Transform */
