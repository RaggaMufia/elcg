/* elcgint.c - elcg random integer Version 1.0.0                   */
...
/* is not validated                                     */
/* See elcgpwr.c for generating an unsigned integer    */
/* of 1-32 bits.                                        */
