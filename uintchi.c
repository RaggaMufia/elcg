...
int main(void)
   ...
   while (i--)
      {
      int indx;
      indx = (elcg(ll) >> 28) & 15;      /* 4 bit sample 0-15 */
   ...
   while (i--)
      {
      int indx;
      indx = (elcg(ll) >> 24) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (elcg(ll) >> 20) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (elcg(ll) >> 16) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (elcg(ll) >> 12) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (elcg(ll) >> 8) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (elcg(ll) >> 4) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = elcg(ll) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
