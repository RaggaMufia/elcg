...
make -f elcgchi.mak clean
make -f elcgdots.mak clean
make -f elcgencr.mak clean
make -f elcggen.mak clean
make -f elcgnorm.mak clean
make -f elcgpat.mak clean
make -f elcgraw.mak clean
make -f elcgtim.mak clean
